...
from DataFlow::PathNode source, DataFlow::PathNode sink, FastjsonUnserialize conf, Class c, Method m
where
...
select c, m, source, sink, "Fastjson", source.toString(),source.getNode().getEnclosingCallable(),source.getNode().getEnclosingCallable().getFile().getAbsolutePath(), 
